export interface Member {
  ...
  membership_duration?: '1_month' | '3_months' | '6_months' | '1_year' | '2_years' | 'lifetime';
...
export interface MemberFormData extends Omit<Member, 'id' | 'tenant_id' | 'created_at' | 'updated_at'> {
  id?: string;
  tenant_id?: string;
}
