...
import { FiSettings, FiUser, FiBell, FiShield, FiCreditCard, FiLink, FiServer, FiZap } from "react-icons/fi";
...
const SettingsCard: React.FC<SettingsCardProps> = ({ title, description, icon, status, lastUpdated, onClick }) => {
  const getStatusColor = () => {
    switch (status) {
      case "configured": return "bg-emerald-100 text-emerald-800 border-emerald-200";
  ...
  const getIconColor = () => {
    switch (status) {
      case "configured": return "bg-emerald-50 text-emerald-600 border-emerald-200";
      case "incomplete": return "bg-orange-50 text-orange-600 border-orange-200";
      case "disabled": return "bg-gray-50 text-gray-600 border-gray-200";
    }
  };
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-4">
        <div className={`p-3 rounded-xl border ${getIconColor()}`}>
          {icon}
        </div>
...
export const SmartSettingsDashboard: React.FC<SmartSettingsDashboardProps> = ({ refreshKey }) => {
  const settingsCategories = [
    {
      title: "System Configuration",
      description: "General system settings, timezone, language, and operational preferences",
    ...
    },
    {
      ...
      description: "Personal settings, dashboard layout, and user interface customization",
    ...
    },
    {
      ...
      description: "Email, SMS, push notification preferences and automation rules",
    ...
    },
    {
      ...
      description: "Password policies, two-factor authentication, and data privacy settings",
    ...
    },
    {
      ...
      description: "Payment methods, billing cycles, tax settings, and invoice customization",
    ...
    {
      title: "Integrations",
      description: "Third-party app connections, API settings, and webhook configurations",
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Smart Settings Dashboard</h1>
          <p className="text-gray-600 mt-1">Manage all system configurations and preferences</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-3xl font-bold text-gray-900">{systemStatus.configured}/{systemStatus.totalSettings}</p>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-3xl font-bold text-gray-900">{systemStatus.systemHealth}</p>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-3xl font-bold text-gray-900">{systemStatus.incomplete}</p>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xl font-bold text-gray-900">{systemStatus.lastBackup}</p>
      ...
      {/* Settings Categories */}
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
        <h2 className="text-xl font-bold text-gray-900 mb-6">Configuration Categories</h2>
      ...
      {/* Recent Activity */}
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
        <h2 className="text-xl font-bold text-gray-900 mb-6">Recent Configuration Changes</h2>
        <div className="space-y-4">
          {[
            { action: "System timezone updated", user: "Admin", time: "2 hours ago", type: "system" },
            { action: "Notification preferences modified", user: "Sarah Johnson", time: "1 day ago", type: "user" },
            { action: "Security policy updated", user: "Admin", time: "3 days ago", type: "security" },
            { action: "Billing settings configured", user: "Admin", time: "1 week ago", type: "billing" }
          ].map((activity, index) => (
            <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-2xl">
              <div className="flex items-center space-x-3">
                <div className={`w-3 h-3 rounded-full ${
                  ...
                  activity.type === 'security' ? 'bg-red-500' : 'bg-orange-500'
                }`}></div>
                <div>
