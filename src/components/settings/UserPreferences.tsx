...
import { FiUser, FiEye, FiLayout, FiEdit, FiSave, FiMoon, FiSun } from "react-icons/fi";

interface UserPreferencesProps {
  refreshKey: number;
}

export const UserPreferences: React.FC<UserPreferencesProps> = ({ refreshKey }) => {
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Customize your experience and interface settings</p>
        </div>
        <button
          onClick={handleSave}
          disabled={isSaving}
      ...
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
        ...
        <div className="space-y-4">
          {[
            ...
            { key: 'compactView', label: 'Compact View', description: 'Use compact layout for tables and lists' },
            ...
            <div key={setting.key} className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                  preferences[setting.key as keyof typeof preferences] ? 'bg-blue-600' : 'bg-gray-300'
                }`}
              >
