...
import { 
  FiCalendar, FiClock, FiUsers, FiDollarSign, FiUser, FiMapPin, 
  FiZap, FiTrendingUp, FiAlertTriangle, FiCheckCircle, FiArrowRight, 
  FiArrowLeft, FiStar, FiTarget, FiBarChart, FiCpu, FiX, FiBook,
  FiActivity, FiTrendingDown, FiAlertCircle, FiHeart, FiSave
} from 'react-icons/fi';
...
interface SmartSolution {
  problemId: string;
  type: 'class_creation' | 'schedule_optimization' | 'pricing_strategy' | 'trainer_allocation';
  title: string;
  description: string;
  implementation: any;
...
const classTypes = [
  ...
  { value: 'strength', label: 'Strength Training', color: '#3B82F6', popularity: 73 },
  { value: 'spin', label: 'Spin Class', color: '#EC4899', popularity: 65 },
];

const optimalTimeSlots = [
  { time: '06:00', label: '6:00 AM', demand: 'High', revenue: '$45', popularity: 88 },
  { time: '07:00', label: '7:00 AM', demand: 'Very High', revenue: '$50', popularity: 95 },
  { time: '09:00', label: '9:00 AM', demand: 'Medium', revenue: '$35', popularity: 65 },
  { time: '12:00', label: '12:00 PM', demand: 'Low', revenue: '$25', popularity: 45 },
  { time: '17:00', label: '5:00 PM', demand: 'High', revenue: '$42', popularity: 85 },
  { time: '18:00', label: '6:00 PM', demand: 'Very High', revenue: '$48', popularity: 92 },
  { time: '19:00', label: '7:00 PM', demand: 'High', revenue: '$45', popularity: 89 },
  { time: '20:00', label: '8:00 PM', demand: 'Medium', revenue: '$38', popularity: 72 }
];
...
const schema = z.object({
  ...
  duration: z.coerce.number().min(15, 'Duration must be at least 15 minutes').max(180, 'Duration cannot exceed 3 hours'),
...
export default function SmartClassFormModal({ isOpen, onClose, onSaved, mode = 'add', classData }: SmartClassFormModalProps) {
    ...
    const problems: GymProblem[] = [
      {
        ...
        description: '6-8 PM slots showing 40% average attendance vs 85% morning slots',
      ...
      },
      {
        ...
        description: 'No classes scheduled 8-10 AM weekends despite high demand',
      ...
      },
      {
        ...
        description: '12 members on yoga class waitlist, current classes at 100%',
      ...
      'low_attendance': [
        {
          ...
          description: 'Create 6:30 PM HIIT class with upbeat music and social elements',
          implementation: {
      ...
      'trainer_utilization': [
        {
          ...
          description: 'Leverage Mike Chen\'s expertise with dedicated strength programs',
          implementation: {
      ...
      'poor_timing': [
        {
          ...
          description: 'High-intensity weekend morning class for busy professionals',
          implementation: {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (trainerConflicts && trainerConflicts.length > 0) {
        toast.error('Trainer is already booked for another class at this time.');
        setLoading(false);
        return;
      }
      ...
      const classPayload = {
        ...
        name: data.name,
        description: data.description || `Smart solution: ${data.solutionStrategy}`,
        type: data.type,
  ...
  const steps = [
    { number: 1, title: 'Problem Analysis', description: 'Identify gym challenges' },
    { number: 2, title: 'Smart Solutions', description: 'AI-powered recommendations' },
    { number: 3, title: 'Solution Configuration', description: 'Customize implementation' },
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        {/* Trainer & Capacity */}
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Trainer & Capacity</h3>
