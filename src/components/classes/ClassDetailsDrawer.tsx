                ...
                {activeTab === "details" && (
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 mb-1 flex items-center gap-2">
                      ...
                      {/* Status badge */}
                      {(() => {
                        const s = getClassStatus(classData);
                        return (
                          <span
                            className={`ml-2 px-2 py-0.5 rounded-full text-xs font-semibold ${s.color}`}
                          >
                            {s.label}
                          </span>
                        );
