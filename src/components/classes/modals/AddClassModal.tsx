...
import { FormField, SelectField, TimeField, DateField, AIRecommendationCard, ConflictAlert } from './SmartFormComponents';
...
const AddClassModal: React.FC<AddClassModalProps> = ({
  ...
  useEffect(() => {
    if (formData.trainer_id && formData.start_time && formData.end_time && formData.date) {
      checkConflicts(formData.trainer_id, formData.start_time, formData.end_time, formData.date);
    }
          ...
          <form className="space-y-6" onSubmit={e => { e.preventDefault(); handleSave(); }}>
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Class Details</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Basic information about your class</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Trainer & Location</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Assign trainer and select room</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <SelectField
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Schedule your class</p>
                </div>
              </div>
                ...
                >
                  <div className="flex items-center space-x-2 mb-3">
                    ...
                    <div className="flex items-center space-x-1 bg-blue-100 dark:bg-blue-800 px-2 py-1 rounded-full">
                      ...
                      <span className="text-xs font-medium text-blue-700 dark:text-blue-300">PRO</span>
                    </div>
                  </div>
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Recurrence</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Set up recurring classes</p>
                </div>
              </div>
              <SelectField
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Set maximum number of participants</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField
