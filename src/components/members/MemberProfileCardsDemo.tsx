...
export const MemberProfileCardsDemo: React.FC = () => {
  ...
  const [currentScenario, setCurrentScenario] = useState<'normal' | 'trial' | 'high-risk'>('normal');
  ...
  const handleSendMessage = () => {
    alert('Send re-engagement message functionality would open messaging interface');
  };
    ...
    switch (currentScenario) {
      case 'trial':
        return {
          ...
          billingData: { ...sampleBillingData, lifetime_value: 0, total_invoices: 0 },
          goalData: { ...sampleGoalData, progress_percentage: 25 },
          riskData: { ...sampleRiskData, churn_risk_score: 45, churn_risk_level: 'medium' as const }
        };
      case 'high-risk':
        return {
          member: { ...sampleMember, membership_status: 'suspended' as const },
          engagementData: lowEngagementData,
          billingData: { ...sampleBillingData, last_payment_status: 'failed' as const },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Member Profile Cards Demo</h1>
              <p className="text-sm text-gray-600">MTDRB Fit - Responsive Member Profile UI Components</p>
            </div>
      ...
      <div className="py-8">
        ...
        <div className="max-w-7xl mx-auto px-6 mb-12">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">Individual Cards</h2>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">Complete Layout</h2>
          <MemberProfileCards
      ...
      <div className="bg-white border-t mt-12">
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-3">Individual Components</h3>
              <div className="space-y-2 text-sm text-gray-600">
                <p>• <code className="bg-gray-100 px-1 rounded">ProfileSummaryCard</code> - Member basic info and status</p>
                <p>• <code className="bg-gray-100 px-1 rounded">EngagementCard</code> - Engagement metrics with circular progress</p>
                <p>• <code className="bg-gray-100 px-1 rounded">BillingCard</code> - Financial summary with action buttons</p>
                <p>• <code className="bg-gray-100 px-1 rounded">GoalsProgressCard</code> - Fitness goals with progress tracking</p>
                <p>• <code className="bg-gray-100 px-1 rounded">RiskAlertsCard</code> - Risk assessment and alerts</p>
              </div>
            </div>
            <div>
