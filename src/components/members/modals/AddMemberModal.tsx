...
import { FiX, FiUser, FiMail, FiPhone, FiMapPin, FiCalendar, FiTarget, FiHeart, FiFileText, FiUsers, FiSettings } from 'react-icons/fi';
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Basic Info</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Health & Fitness</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Member's health and fitness details</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange('target_weight', parseFloat(e.target.value) || undefined)}
                    className="form-input"
                ...
                <div>
                  <label className="flex items-center space-x-3">
                    <input
                      ...
                      onChange={(e) => handleInputChange('previous_gym_experience', e.target.checked)}
                      className="form-checkbox"
                    />
                    <span className="text-sm text-gray-700 dark:text-gray-300">Previous Gym Experience</span>
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Goals & Preferences</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Member's goals and workout preferences</p>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Health Conditions</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Member's health conditions and previous injuries</p>
                </div>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {healthConditionOptions.map(condition => (
                  <label key={condition.value} className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => handleArrayChange('health_conditions', condition.value, e.target.checked)}
                      className="form-checkbox"
                    />
                    <span className="text-sm text-gray-700 dark:text-gray-300">
                      {condition.label}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Member's medical conditions and previous injuries</p>
                </div>
              </div>
                    ...
                    {['Shoulder', 'Knee', 'Back', 'Ankle', 'Wrist', 'Hip', 'None'].map(injury => (
                      <label key={injury} className="flex items-center space-x-2">
                        <input
                          ...
                          onChange={(e) => handleArrayChange('injuries', injury, e.target.checked)}
                          className="form-checkbox"
                        />
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Notes and staff information</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
