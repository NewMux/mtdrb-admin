...
export default function LearnMoreInsightModal({
  ...
  return (
    <SmartAnalyticsModal
      ...
      subtitle="Deep dive into smart logic and supporting data"
    >
      {/* Alerts */}
      {alerts.map((alert, i) => (
        <div
      ...
      <Section title="Analysis Details">
        <div className="border-b border-gray-200">
          <nav className="flex space-x-8">
            {[
              { id: "logic", label: "Smart Logic", icon: FiZap },
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {insightDetails.aiLogic.algorithm}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Training Data:</span>
                    <span className="font-medium">
                      {insightDetails.aiLogic.trainingData}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Accuracy:</span>
                    <span className="font-medium">
                      {insightDetails.aiLogic.accuracy}
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">
                      Retention has declined by 14% over the last 4 months,
                      indicating a systemic issue that requires immediate
                      attention.
                    </p>
                  </div>
                </div>
