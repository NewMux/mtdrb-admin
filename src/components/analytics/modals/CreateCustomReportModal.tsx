...
const availableSections = [
  {
    ...
    label: "Attendance %",
    icon: FiUsers,
    description: "Member attendance rates and trends",
  },
  {
    id: "payment",
    label: "Payment Analytics",
    icon: FiDollarSign,
    description: "Revenue, payments, and billing data",
  },
  {
    id: "trainer_feedback",
    label: "Trainer Feedback",
    icon: FiUsers,
    description: "Trainer ratings and member feedback",
  },
  {
    id: "retention",
  ...
  },
  {
    ...
    icon: FiBarChart2,
    description: "Member engagement and activity levels",
  },
  {
    id: "financial",
...
export default function CreateCustomReportModal({
  open,
  onClose,
  onSuccess,
  isPro,
}: CreateCustomReportModalProps) {
  ...
  return (
    <SmartAnalyticsModal
      ...
      subtitle="Build your own report with drag-and-drop sections and smart recommendations"
    >
      {/* Alerts */}
      {alerts.map((alert, i) => (
        <div
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                {!selectedSections.includes("retention") && (
                  <li className="flex items-center gap-2">
                    <span>•</span>
                    <span>
                      Add <strong>Retention Score</strong> for better member
                      analysis
                    </span>
                    {!isPro && (
                      <FiLock className="text-gray-400" title="Pro feature" />
                ...
                {selectedSections.length < 3 && (
                  <li className="flex items-center gap-2">
                    <span>•</span>
                    <span>
                      Consider adding <strong>Engagement Metrics</strong> for
                      comprehensive view
                    </span>
                  </li>
                )}
                <li className="flex items-center gap-2">
                  <span>•</span>
                  <span>
                    This combination will provide excellent insights for member
                    management
                  </span>
                </li>
              </ul>
                ...
                {selectedSections.map((sectionId) => (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-3">
                      {React.createElement(getSectionIcon(sectionId), {
