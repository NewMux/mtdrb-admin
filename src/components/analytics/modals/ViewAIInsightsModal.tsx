...
import { FiZap, FiTrendingUp, FiTrendingDown, FiAlertTriangle, FiUsers, FiDollarSign, FiLock, FiPlay, FiSettings } from 'react-icons/fi';
...
const aiInsights = [
  ...
  },
  {
    ...
    description: 'HIIT Blast class at 110% capacity - recommend duplicate session',
    confidence: 94,
    impact: 'medium',
    category: 'operations',
    icon: FiUsers,
...
const insightCategories = [
  ...
  { id: 'retention', label: 'Retention', count: aiInsights.filter(i => i.category === 'retention').length },
  { id: 'revenue', label: 'Revenue', count: aiInsights.filter(i => i.category === 'revenue').length },
  { id: 'operations', label: 'Operations', count: aiInsights.filter(i => i.category === 'operations').length },
  { id: 'performance', label: 'Performance', count: aiInsights.filter(i => i.category === 'performance').length },
];

export default function ViewAIInsightsModal({ open, onClose, onSuccess, isPro }: ViewAIInsightsModalProps) {
  ...
  const [applyingAction, setApplyingAction] = React.useState<string | null>(null);
  ...
  if (!isPro) {
    return (
      <SmartAnalyticsModal
        ...
        onClose={onClose}
        title="AI Insights"
        subtitle="Pro feature - Upgrade to access AI-powered insights"
      >
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-6">
            AI Insights provide advanced analytics and predictive recommendations to optimize your gym operations.
          </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  <h5 className="font-medium text-gray-900 mb-1">Immediate Actions</h5>
                ...
                <div>
                  <h5 className="font-medium text-gray-900 mb-1">Long-term Strategies</h5>
                  <ul className="space-y-1 text-gray-600">
