...
export default function ApplyRecommendationModal({
  ...
  return (
    <SmartAnalyticsModal
      ...
      subtitle="Implement smart-powered insights to optimize your operations"
    >
      {/* Alerts */}
      {alerts.map((alert, i) => (
        <div
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <Icon
                      className={`${selectedAction === option.id ? "text-blue-600" : "text-gray-500"}`}
                    />
                    <h4 className="font-semibold text-gray-900">
                      {option.label}
                    </h4>
                ...
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setCustomSettings({
                        ...customSettings,
                        includeIncentive: e.target.checked,
                      })
                    }
                    className="rounded"
                  />
                  <span className="text-sm font-medium">
                    Include incentive offer
                  </span>
                </label>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Recommended time: <strong>9:00 AM</strong> (highest
                    engagement rate)
                  </p>
                </div>
              </div>
