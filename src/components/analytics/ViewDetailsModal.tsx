...
import { FiX, FiBarChart, FiTrendingUp, FiUsers, FiDollarSign, FiCalendar } from 'react-icons/fi';
...
const ViewDetailsModal: React.FC<ViewDetailsModalProps> = ({
  ...
  const getSectionIcon = (section: string) => {
    switch (section) {
      ...
      case 'classes': return FiCalendar;
  ...
  const getSectionTitle = (section: string) => {
    switch (section) {
      ...
      case 'classes': return 'Class Details';
  ...
  const getSectionDescription = (section: string) => {
    switch (section) {
      case 'revenue': return 'Comprehensive revenue analysis and financial metrics';
      case 'members': return 'Detailed member activity and engagement data';
      case 'classes': return 'Class performance and attendance analytics';
      default: return 'Detailed analytics breakdown';
    }
  };
          ...
          {section === 'revenue' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
                <div className="text-2xl font-bold text-green-600">45,280 BHD</div>
          ...
          {section === 'members' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400">At-Risk Members</div>
              </div>
            </div>
          )}
          ...
          {section === 'classes' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400">Classes This Month</div>
              </div>
              <div className="p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
            ...
            <div className="flex items-center justify-center h-32">
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Interactive charts and detailed breakdowns would be displayed here
                </p>
