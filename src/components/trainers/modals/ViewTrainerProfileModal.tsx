...
import { FiUser, FiMail, FiPhone, FiStar, FiTarget, FiClock, FiX, FiEdit, FiMessageSquare } from 'react-icons/fi';
...
export default function ViewTrainerProfileModal({ isOpen, onClose, trainer, onSuccess, isPro = false }: ViewTrainerProfileModalProps) {
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start gap-4">
          <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-sky-400 to-rose-400 flex items-center justify-center">
            <span className="text-white font-medium text-lg">{trainer.avatar}</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              ...
              <div>
                ...
                <div className="flex items-center gap-1">
                  {renderStars(trainer.rating)}
                  <span className="text-sm text-gray-600 ml-1">{trainer.rating}/5</span>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              <FiClock className="text-gray-400" />
              <div>
                <p className="text-sm font-medium text-gray-900">Classes Assigned</p>
                <p className="text-sm text-gray-600">{trainer.classes} classes</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              <div className="text-2xl font-bold text-blue-600">{trainer.classes}</div>
