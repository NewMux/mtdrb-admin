...
import { FiSettings, FiSave, FiX, FiZap, FiTarget, FiClock, FiTrendingUp } from 'react-icons/fi';
            ...
            {[
              ...
              <label key={index} className="flex items-center space-x-3">
                <input
                  ...
                  onChange={(e) => {
                    if (e.target.checked) {
                      handleInputChange('triggerConditions', [...config.triggerConditions, condition]);
                    } else {
                      handleInputChange('triggerConditions', config.triggerConditions.filter(c => c !== condition));
                    }
                  }}
                ...
                <input
                  ...
                  onChange={(e) => {
                    if (e.target.checked) {
                      ...
                      handleInputChange('actions', config.actions.filter(a => a !== action));
                    }
                  }}
                  className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                />
          ...
          <div className="space-y-4">
            <label className="flex items-center space-x-3">
              <input
                ...
                className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              <span className="text-sm text-gray-700">Send notifications for workflow events</span>
            </label>
            ...
            <label className="flex items-center space-x-3">
              <input
                ...
                className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              <span className="text-sm text-gray-700">Auto-optimize based on performance data</span>
            </label>
          </div>
        </div>
