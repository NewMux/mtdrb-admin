...
export default function AddTrainerModal({ isOpen, onClose, onSuccess, isPro = false }: AddTrainerModalProps) {
  ...
  const handleInputChange = (field: keyof TrainerFormData, value: string | number) => {
