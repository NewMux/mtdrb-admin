...
export default function BillingAutomationEngine({
  refreshKey,
}: BillingAutomationEngineProps) {
      ...
      const mockWorkflows: AutomationWorkflow[] = [
        {
          ...
          description:
            "Automatically sends payment reminders to members with overdue invoices",
        ...
        },
        {
          ...
          description:
            "Automatically processes subscription renewals and sends confirmation",
        ...
        },
        {
          ...
          name: "Welcome Series",
          description:
            "Sends welcome emails and onboarding materials to new members",
          type: "welcome",
          status: "active",
        ...
        },
        {
          ...
          description:
            "Aggressive collection process for severely overdue invoices",
  ...
  const toggleWorkflowStatus = async (workflowId: string) => {
    try {
      ...
      toast.success(
        `Workflow ${newStatus === "active" ? "activated" : "paused"} successfully`,
      );
    } catch (error) {
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              ...
              <div className="text-2xl font-bold">
                {safeToLocaleString(
                  workflows.reduce((sum, w) => sum + (w.executions || 0), 0),
                )}
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Manage your billing automation processes
                </p>
              </div>
            </div>
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <div
                        className={`bg-gradient-to-r ${getWorkflowColor(workflow.type)} p-3 rounded-xl`}
                      >
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-xs text-gray-500">
                      <div>
                        Executions: {safeToLocaleString(workflow.executions)}
                      </div>
                      <div>
                        Last run:{" "}
                        {workflow.last_run
