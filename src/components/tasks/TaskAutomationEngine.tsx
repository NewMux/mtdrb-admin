    ...
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200 hover:shadow-md transition-all duration-300 ease-in-out">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-start space-x-3">
          <div
            className={`p-3 rounded-xl border ${getCategoryColor(workflow.category)}`}
          >
            {workflow.icon}
          </div>
          <div>
            <h3 className="font-semibold text-gray-900 mb-1 tracking-tight">
              {workflow.name}
            </h3>
      ...
      <div className="flex items-center justify-between">
        <div className="text-sm text-gray-500">
          <span className="font-medium">{workflow.triggerCount}</span> triggers
...
const TaskAutomationEngine: React.FC<TaskAutomationEngineProps> = ({
  refreshKey,
}) => {
  const [workflows, setWorkflows] = React.useState<Workflow[]>([
    {
      ...
      description:
        "Automated welcome sequence with task creation for new members",
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "Auto-create tasks for class setup, equipment checks, and material prep",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
    ...
    },
    {
      ...
      description:
        "Intelligent follow-up task creation based on member behavior",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
    ...
    },
    {
      ...
      description:
        "Automated maintenance tasks based on equipment usage and schedules",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
    ...
    },
    {
      ...
      description:
        "Auto-assign tasks to staff based on availability and skills",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
  ...
  const [showConfiguration, setShowConfiguration] = React.useState<
    string | null
  >(null);
  ...
  const categories = [
    { id: "all", name: "All Workflows", count: workflows.length },
    {
      ...
      count: workflows.filter((w) => w.category === "member-management").length,
    },
    {
      id: "staff-operations",
      name: "Staff Operations",
      count: workflows.filter((w) => w.category === "staff-operations").length,
    },
    {
      id: "facility",
      name: "Facility",
      count: workflows.filter((w) => w.category === "facility").length,
    },
    {
      id: "communication",
      name: "Communication",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Smart workflows to automate routine gym management tasks
          </p>
        </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {workflows
                .sort(
                  (a, b) =>
                    parseFloat(b.revenueImpact.replace(/[^0-9.-]/g, "")) -
                    parseFloat(a.revenueImpact.replace(/[^0-9.-]/g, "")),
                )
                .slice(0, 3)
                .map((workflow, index) => (
                  <div
