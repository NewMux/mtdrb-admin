      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Manage all promotional campaigns and offers
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-gray-700">
          <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">
            ...
            {promotions
              .reduce(
                (sum, p) => sum + parseInt(p.revenue.replace(/[^0-9]/g, "")),
                0,
              )
              .toLocaleString()}
          </p>
            ...
            <tbody>
              {promotions.map((promo) => (
                ...
                >
                  ...
                  <td className="p-4">
                    <span
                      className={`px-2 py-1 rounded-full text-sm font-medium ${statusColors[promo.status as keyof typeof statusColors]}`}
                    >
                  ...
                  <td className="p-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <button
                        onClick={() =>
                          alert(`View analytics for ${promo.name}`)
                        }
