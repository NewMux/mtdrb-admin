...
import { FiTrendingUp, FiTrendingDown, FiGift, FiTarget, FiUsers, FiDollarSign, FiCalendar, FiMail, FiPhone, FiZap, FiBarChart } from 'react-icons/fi';
...
const PromotionInsight: React.FC<PromotionInsightProps> = ({ icon, title, description, action, priority, value }) => {
...
const SmartPromotionsDashboard: React.FC<SmartPromotionsDashboardProps> = ({ refreshKey, stats }) => {
  const kpis = [
    {
  ...
  const insights = [
    {
      ...
      description: 'Create New Year fitness promotion targeting inactive members',
    ...
    },
    {
      ...
      description: 'Send push reminders to members who opened emails but didn\'t convert',
      action: 'Send Push',
      priority: 'medium' as const,
      value: '156 members'
    },
    {
      ...
      description: 'Member birthday promotions show 45% higher conversion rates',
  ...
  const topPromotions = [
    { name: 'New Year Fitness Challenge', conversions: 89, revenue: '$4,450', roi: '340%' },
    { name: 'Friend Referral Bonus', conversions: 67, revenue: '$3,350', roi: '280%' },
    { name: 'Holiday Membership Special', conversions: 45, revenue: '$2,250', roi: '225%' },
    { name: 'Student Discount Program', conversions: 34, revenue: '$1,700', roi: '190%' }
  ];

  const channelPerformance = [
    { channel: 'Email', sent: 2450, opened: 784, converted: 156, rate: '19.9%' },
    { channel: 'In-App', sent: 890, opened: 623, converted: 145, rate: '23.3%' },
    { channel: 'Social Media', sent: 3200, opened: 1280, converted: 89, rate: '7.0%' }
  ];
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Smart Promotions Dashboard</h1>
          <p className="text-gray-600 mt-1">AI-powered promotion insights and performance analytics</p>
        </div>
      ...
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-gray-900">AI Promotion Insights</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
          <h3 className="text-lg font-bold text-gray-900 mb-4">Top Performing Promotions</h3>
            ...
            {topPromotions.map((promo, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-2xl">
                <div>
                  ...
                  <p className="text-sm text-gray-600">{promo.conversions} conversions</p>
                </div>
              ...
              <div key={index} className="flex items-center justify-between">
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="font-bold text-blue-600">{channel.rate}</span>
                  </div>
