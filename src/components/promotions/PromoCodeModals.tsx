...
import { FiX, FiGift, FiPercent, FiDollarSign, FiCalendar, FiUsers, FiTarget, FiSettings, FiCheck, FiCopy } from 'react-icons/fi';
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-600">
                {isEditMode ? 'Update your discount code settings' : 'Design discount codes to drive member engagement'}
              </p>
            </div>
          </div>
          <button
