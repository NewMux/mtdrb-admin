...
import { FiZap, FiCpu, FiTrendingUp, FiAward, FiArrowRight } from 'react-icons/fi';
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold">Unlock AI Campaigns & Automation</h2>
              <p className="text-purple-100 mt-1">Take your promotions to the next level with smart features</p>
            </div>
          </div>
        ...
        <div className="hidden lg:block ml-8">
          <div className="bg-white/10 rounded-2xl p-6 backdrop-blur-sm">
            <div className="text-center">
              ...
              <div className="text-purple-100 text-sm">Average revenue increase</div>
      ...
      <div className="mt-6 pt-4 border-t border-white/20">
        <div className="flex items-center justify-between text-sm">
          <span className="text-purple-100">💡 Pro users see 3.2x better campaign performance</span>
