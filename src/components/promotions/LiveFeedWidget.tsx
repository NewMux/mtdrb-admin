...
import { FiGift, FiUsers, FiTrendingUp, FiMail, FiPhone, FiTarget, FiClock, FiAward, FiZap } from 'react-icons/fi';
import { motion, AnimatePresence } from 'framer-motion';

interface LiveActivity {
  id: string;
  type: 'redemption' | 'opened' | 'converted' | 'referred' | 'birthday' | 'milestone';
  message: string;
  member: string;
  campaign: string;
  value?: string;
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Real-time campaign engagement</p>
          </div>
        </div>
