...
import { FiSearch, FiFilter, FiEdit, FiTrash2, FiEye, FiCopy, FiCheck, FiX, FiMoreVertical, FiDownload, FiRefreshCw } from 'react-icons/fi';
...
const PromoCodeManagement: React.FC<PromoCodeManagementProps> = ({ onEditPromoCode }) => {
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">View, edit, and manage all your discount codes</p>
        </div>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {sortedCodes.map((code) => (
                <tr key={code.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">
                    <div>
                      <div className="flex items-center justify-between text-sm mb-1">
                        <span className="text-gray-900">{code.usedCount}/{code.maxUses}</span>
                        <span className="text-gray-500">{getUsagePercentage(code.usedCount, code.maxUses)}%</span>
                      </div>
                  ...
                  <td className="px-6 py-4">
                    <div>
                      <div className="font-semibold text-green-600">${code.revenue.toLocaleString()}</div>
                      <div className="text-sm text-gray-500">{code.conversionRate}% conversion</div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
