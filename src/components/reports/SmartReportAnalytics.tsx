      ...
      setAnalytics([
        {
          ...
          insight:
            "Financial reports lead in accuracy while member reports show highest engagement",
        },
      ]);
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-emerald-100">
              Performance insights and user engagement analytics
            </p>
          </div>
        </div>
            ...
            <div key={index} className="bg-white bg-opacity-10 rounded-xl p-4">
              ...
              <div className="text-2xl font-bold">
                {metric.label === "Avg. Response Time"
                  ? `${metric.value}s`
                  : metric.label === "User Satisfaction"
                    ? `${metric.value}/5`
