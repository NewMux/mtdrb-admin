...
import { FiAlertTriangle, FiTrendingUp, FiUsers, FiDollarSign, FiCalendar, FiZap } from 'react-icons/fi';
...
const getCategoryIcon = (category: SmartInsight['category']) => {
  switch (category) {
    ...
    case 'member': return FiUsers;
    case 'class': return FiCalendar;
    case 'revenue': return FiDollarSign;
    default: return FiZap;
  }
};

export default function SmartInsightCards({ insights, onActionClick, isPro = false }: SmartInsightCardsProps) {
    ...
    return (
      ...
      >
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Get smart recommendations to optimize your gym operations</p>
