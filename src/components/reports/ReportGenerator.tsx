...
import { FiFileText, FiDownload, FiSettings, FiCalendar, FiUsers, FiDollarSign, FiTrendingUp, FiBarChart, FiTarget, FiActivity, FiPlus, FiX, FiCheck } from 'react-icons/fi';
...
export default function ReportGenerator({ refreshKey, isPro = false }: ReportGeneratorProps) {
    ...
    try {
      const templateData: ReportTemplate[] = [
        ...
        },
        {
          ...
          category: 'member',
          fields: ['member_count', 'retention_rate', 'engagement_score', 'churn_rate'],
          icon: FiUsers,
          color: 'green',
          popularity: 88
        },
        {
          ...
          category: 'trainer',
          fields: ['trainer_rating', 'session_count', 'member_feedback', 'revenue_generated'],
          icon: FiTrendingUp,
          color: 'purple',
          popularity: 82
        },
        {
          ...
          description: 'Class attendance, capacity, and optimization recommendations',
          category: 'operational',
          fields: ['attendance_rate', 'capacity_utilization', 'popular_classes', 'scheduling_efficiency'],
          icon: FiBarChart,
          color: 'orange',
          popularity: 76
        },
        {
          ...
          category: 'financial',
          fields: ['projected_revenue', 'trend_analysis', 'seasonal_patterns', 'growth_opportunities'],
          icon: FiTarget,
          color: 'indigo',
          popularity: 71
        },
        {
          ...
          category: 'member',
          fields: ['health_metrics', 'goal_progress', 'wellness_score', 'activity_trends'],
          icon: FiActivity,
          color: 'emerald',
          popularity: 68
        }
  ...
  const fetchAvailableFields = async () => {
    const fields = {
      financial: [
        'revenue', 'expenses', 'profit_margin', 'growth_rate', 'cash_flow',
        'subscription_revenue', 'one_time_payments', 'refunds', 'tax_analysis'
      ],
      member: [
        'member_count', 'retention_rate', 'churn_rate', 'engagement_score',
        'demographics', 'membership_types', 'activity_levels', 'satisfaction_score'
      ],
      trainer: [
        'trainer_rating', 'session_count', 'member_feedback', 'revenue_generated',
        'specialties', 'certifications', 'availability', 'performance_trends'
      ],
      operational: [
        'attendance_rate', 'capacity_utilization', 'equipment_usage', 'facility_metrics',
        'scheduling_efficiency', 'peak_hours', 'maintenance_costs', 'energy_consumption'
      ]
    };
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-orange-100">Create custom reports with AI-powered insights</p>
            </div>
          </div>
      ...
      {!isCustomMode ? (
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-200">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-900">Popular Report Templates</h3>
            <div className="flex items-center gap-2">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-200">
          {!isPro && (
            <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-100 rounded-xl border border-blue-200">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <h4 className="font-semibold text-gray-900">Advanced Report Features</h4>
                  <p className="text-sm text-gray-600">Unlock multi-branch reports, predictive analytics, and custom date ranges</p>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setCustomReport(prev => ({ ...prev, category: e.target.value, selectedFields: [] }))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                >
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Branches {!isPro && <span className="text-xs text-gray-500">(Pro feature)</span>}
                </label>
                <select
                  multiple
                  disabled={!isPro}
                ...
                {!isPro && (
                  <p className="text-xs text-gray-500 mt-1">Upgrade to Pro for multi-branch reports</p>
                )}
              </div>
              ...
              <div>
                ...
                <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                  ...
                  {isPro && <option value="predictive">Predictive Analysis</option>}
                </select>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setCustomReport(prev => ({ ...prev, schedule: e.target.value }))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                >
            ...
            <div>
              ...
              <div className="space-y-2 max-h-80 overflow-y-auto">
                {availableFields[customReport.category as keyof typeof availableFields]?.map((field) => (
                  <div
                    key={field}
          ...
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
            <div className="text-sm text-gray-500">
              {customReport.selectedFields.length > 0 && `${customReport.selectedFields.length} fields selected`}
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                disabled={!customReport.name || customReport.selectedFields.length === 0}
