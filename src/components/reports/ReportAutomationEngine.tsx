...
export default function ReportAutomationEngine({
  refreshKey,
}: ReportAutomationEngineProps) {
    ...
    try {
      ...
      const workflowData: AutomationWorkflow[] = [
        {
          ...
          description:
            "Automated daily financial performance report sent to management",
          type: "financial",
          status: "active",
          frequency: "daily",
          successRate: 98,
        ...
        },
        {
          ...
          description:
            "Detailed trainer performance metrics and recommendations",
          type: "trainer",
          status: "active",
          frequency: "monthly",
          successRate: 94,
        ...
        },
        {
          ...
          description:
            "Complete business intelligence report with strategic insights",
          type: "operational",
          status: "paused",
          frequency: "quarterly",
          successRate: 92,
        ...
        },
        {
          ...
          description:
            "Class performance and scheduling optimization recommendations",
          type: "operational",
          status: "active",
          frequency: "weekly",
          successRate: 89,
      ...
      const metricsData: AutomationMetric[] = [
        ...
        },
        {
          label: "Success Rate",
          value: Math.round(
            workflowData.reduce((sum, w) => sum + w.successRate, 0) /
              workflowData.length,
          ),
          change: 12,
          icon: FiCheckCircle,
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-purple-100">
              Smart workflows and automated report generation
            </p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            ...
            {workflows
              .filter(
                (w) => w.frequency === "daily" || w.frequency === "weekly",
              )
              .slice(0, 3)
              .map((workflow, index) => (
                <div
              ...
              .map((workflow, index) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-600">
                      {workflow.recipients} recipients
                    </div>
                  </div>
