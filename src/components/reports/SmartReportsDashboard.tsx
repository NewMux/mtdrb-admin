...
import { FiCpu, FiTrendingUp, FiUsers, FiDollarSign, FiActivity, FiTarget, FiZap, FiFileText, FiCalendar, FiDownload, FiBarChart, FiMessageSquare } from 'react-icons/fi';
...
export default function SmartReportsDashboard({ refreshKey, stats }: SmartReportsDashboardProps) {
      ...
      setInsights([
        {
          ...
          insight: 'Automation efficiency increased 33% this quarter - on track for 95% target'
        }
      ]);

      setRecentReports([
        { name: 'Monthly Member Analytics', type: 'Member Report', status: 'Completed', time: '2 hours ago', downloads: 23 },
        { name: 'Q2 Financial Summary', type: 'Financial Report', status: 'Processing', time: '30 mins ago', downloads: 0 },
        { name: 'Trainer Performance Review', type: 'Trainer Report', status: 'Completed', time: '1 hour ago', downloads: 12 },
        { name: 'Class Attendance Analysis', type: 'Class Report', status: 'Scheduled', time: 'Tomorrow 9 AM', downloads: 0 },
        { name: 'Revenue Forecast', type: 'Financial Report', status: 'Completed', time: '4 hours ago', downloads: 31 }
      ]);
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl shadow-xl p-6 text-white">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-2xl font-bold">AI Report Intelligence</h2>
            <p className="text-blue-100">Smart insights and predictive analytics for comprehensive business reporting</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white bg-opacity-10 rounded-xl p-4">
            ...
            <div className="text-xs text-blue-200">AI Recommendations</div>
          </div>
        </div>
      </div>
          ...
          <div key={index} className="bg-white rounded-2xl shadow-lg p-6 border border-gray-200">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={insight.data}>
                ...
                <Line 
                  type="monotone" 
                  dataKey={insight.type === 'performance' ? 'efficiency' : 'value'} 
                  stroke="#3B82F6" 
                  strokeWidth={2}
                />
              </LineChart>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">{report.type} • {report.time}</div>
                </div>
              </div>
