    ...
    try {
      ...
      const metricsData: ReportMetric[] = [
        ...
        },
        {
          label: "Success Rate",
          value: Math.round(
            reportsData.reduce((sum, r) => sum + r.successRate, 0) /
              reportsData.length,
          ),
          change: 5,
          color: "green",
        },
        {
          ...
          value: Array.from(new Set(reportsData.flatMap((r) => r.recipients)))
            .length,
          change: 15,
          color: "purple",
        },
    ...
    setScheduledReports((prev) =>
      prev.map((report) => {
        if (report.id === reportId) {
          ...
          toast.success(
            `Report ${newStatus === "active" ? "activated" : "paused"}`,
          );
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-teal-100">
                Automated report delivery and scheduling management
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium">
                {
                  scheduledReports.filter((r) => r.deliveryMethod === "email")
                    .length
                }
              </span>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-200">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium">
                {
                  scheduledReports.filter((r) => r.frequency === "weekly")
                    .length
                }
              </span>
            </div>
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium">
                {
                  scheduledReports.filter((r) => r.frequency === "monthly")
                    .length
                }
              </span>
            </div>
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium">
                {
                  scheduledReports.filter((r) => r.frequency === "quarterly")
                    .length
                }
              </span>
            </div>
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium text-green-600">
                {Math.round(
                  scheduledReports.reduce((sum, r) => sum + r.successRate, 0) /
