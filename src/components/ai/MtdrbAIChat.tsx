          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-blue-100 bg-blue-50 rounded-t-2xl">
              ...
              <button
                ...
                className="text-blue-400 hover:text-blue-700 p-1 rounded-full focus:outline-none"
              >
                <FiX size={20} />
              </button>
            </div>
            {/* Chat History */}
            <div
              className="flex-1 px-4 py-3 overflow-y-auto bg-blue-50"
              style={{ minHeight: 0 }}
            >
              {messages.map((msg, i) => (
                <div
                ...
                >
                  <div
                    className={`rounded-2xl px-3 py-2 max-w-[80%] text-sm ${msg.role === "user" ? "bg-blue-600 text-white" : "bg-white text-blue-900 border border-blue-100"}`}
                  >
                    {msg.text}
                  </div>
                </div>
