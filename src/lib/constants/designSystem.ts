...
export const MODAL_STYLES = {
  ...
  // Header
  header: {
    container: 'sticky top-0 z-10 bg-white border-b border-gray-200/50 px-8 py-6',
    title: 'text-xl font-semibold text-gray-900 tracking-tight',
    subtitle: 'text-sm text-gray-600 mt-1',
    closeButton: 'text-gray-400 hover:text-gray-600 transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-xl p-2',
  },
  ...
  // Footer
  footer: {
    container: 'sticky bottom-0 bg-white border-t border-gray-200/50 px-8 py-6',
    actions: 'flex items-center justify-end space-x-3',
  },

  // Form Sections
  form: {
    section: 'bg-gray-50/50 rounded-xl p-6 mb-6',
    sectionTitle: 'text-base font-semibold text-gray-900 mb-4',
    sectionDescription: 'text-sm text-gray-600 mb-4',
    fieldGroup: 'space-y-4',
    field: 'space-y-2',
    label: 'block text-sm font-medium text-gray-700',
    input: 'w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200',
    select: 'w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200',
    textarea: 'w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200',
...
export const COMPONENT_CLASSES = {
  // Cards
  card: {
    base: 'bg-white rounded-2xl shadow-lg border border-gray-200/50',
  ...
  button: {
    ...
    secondary: 'bg-gray-100 text-gray-700 hover:bg-gray-200 rounded-xl px-4 py-2 transition-colors duration-200',
    ghost: 'text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-xl px-4 py-2 transition-colors duration-200',
  ...
  modal: {
    backdrop: 'fixed inset-0 bg-black/40 backdrop-blur-sm',
    content: 'fixed right-0 top-0 h-full w-full max-w-4xl bg-white shadow-2xl',
    header: 'sticky top-0 z-10 bg-white border-b border-gray-200/50 px-8 py-6',
    body: 'flex-1 overflow-y-auto px-8 py-6',
    footer: 'sticky bottom-0 bg-white border-t border-gray-200/50 px-8 py-6',
  },
  ...
  // Tables
  table: {
    container: 'bg-white rounded-2xl shadow-lg border border-gray-200/50 overflow-hidden',
    header: 'bg-gray-50 border-b border-gray-200/50',
  ...
  // Navigation
  nav: {
    item: 'px-4 py-2 rounded-xl hover:bg-gray-100 transition-colors duration-200',
