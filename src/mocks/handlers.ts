...
export const handlers = [
  ...
  http.get('https://*/rest/v1/members', () => {
    return Response.json([
      { id: '1', name: 'Alice Example', status: 'active', email: 'alice@example.com' },
      { id: '2', name: 'Bob Example', status: 'inactive', email: 'bob@example.com' },
    ]);
  }),
  ...
  http.get('https://*/rest/v1/classes', () => {
    return Response.json([
      { id: '101', name: 'Yoga', start_time: '2024-07-05T10:00:00Z', end_time: '2024-07-05T11:00:00Z' },
      { id: '102', name: 'Pilates', start_time: '2024-07-05T12:00:00Z', end_time: '2024-07-05T13:00:00Z' },
    ]);
  }),
