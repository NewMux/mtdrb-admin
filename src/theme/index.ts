...
export const designTokens = {
  ...
  card: {
    ...
    hover: 'hover:shadow-md hover:border-gray-200 dark:hover:border-gray-600 transition-all duration-300',
  ...
  // Form styles
  form: {
    input: 'w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-sky-500 focus:border-transparent transition-all duration-300',
    select: 'w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-sky-500 focus:border-transparent transition-all duration-300',
    textarea: 'w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-sky-500 focus:border-transparent transition-all duration-300 resize-none',
    label: 'block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2',
  },
  
  // Table styles
  table: {
    container: 'w-full overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-700',
    header: 'bg-gray-50 dark:bg-gray-800 px-6 py-4 text-left text-sm font-medium text-gray-700 dark:text-gray-300',
  ...
  modal: {
    ...
    container: 'fixed top-0 right-0 h-full w-full max-w-2xl bg-white dark:bg-gray-900 shadow-2xl z-50',
    header: 'sticky top-0 z-10 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-6 py-4',
    content: 'flex-1 overflow-y-auto px-6 py-4',
    footer: 'sticky bottom-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 px-6 py-4',
  },
  
  // Tab styles
  tab: {
    container: 'border-b border-gray-200 dark:border-gray-700',
    button: 'px-4 py-3 text-sm font-medium text-gray-500 dark:text-gray-400 border-b-2 border-transparent hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-300',
...
export const tailwindConfig = {
  button: {
    primary: 'bg-blue-600 hover:bg-blue-700 text-white font-semibold px-5 py-2.5 rounded-xl transition-all duration-300 ease-in-out min-h-[44px] dark:bg-blue-500 dark:hover:bg-blue-400',
    secondary: 'border border-gray-300 text-gray-700 bg-gray-100 hover:bg-gray-200 font-semibold px-5 py-2.5 rounded-xl transition-all duration-300 ease-in-out min-h-[44px] dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-600',
    success: 'bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-5 py-2.5 rounded-xl transition-all duration-300 ease-in-out min-h-[44px] dark:bg-emerald-500',
    warning: 'bg-orange-600 hover:bg-orange-700 text-white font-semibold px-5 py-2.5 rounded-xl transition-all duration-300 ease-in-out min-h-[44px] dark:bg-orange-500',
    ghost: 'text-gray-500 hover:text-gray-700 bg-transparent px-4 py-2 rounded-xl transition-all duration-300 ease-in-out min-h-[44px] dark:text-gray-400 dark:hover:text-white',
  },
  card: {
          base: 'bg-white p-6 rounded-2xl shadow-sm gap-2 dark:bg-gray-800 dark:shadow-lg dark:border-gray-700',
    success: 'bg-emerald-50 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-400',
    alert: 'bg-orange-50 text-orange-700 dark:bg-orange-950 dark:text-orange-400',
    error: 'bg-red-50 text-red-700 dark:bg-red-950 dark:text-red-400',
    analytics: 'bg-indigo-50 text-indigo-700 dark:bg-indigo-950 dark:text-indigo-400',
