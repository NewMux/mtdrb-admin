...
const PROJECT_KB = [
  ...
  },
  {
    ...
    content: 'MTDRB Admin is a modern web admin dashboard for gym/fitness business management. Built with React, Supabase, Tailwind, and more. Key features include memberships, classes, billing, trainers, analytics, and multi-tenant support.'
  },
  {
  ...
  },
  {
    ...
    content: 'src/: All frontend code. supabase/: All database migrations and SQL. components/: UI components by feature. pages/: Top-level route pages. types/: TypeScript types. utils/: Utility functions.'
  },
  {
    title: 'Key Features',
    content: 'Memberships, Classes, Billing, Trainers, Reports, Tasks, Promotions, Notifications. Each feature has its own page, components, and database tables.'
  },
  {
    title: 'UI/UX Patterns',
    content: 'Apple-style, modern, desktop-first. Drawers for add/edit/view. KPI cards at the top. Tables/lists with search, filter, and actions. Responsive and beautiful.'
  },
  {
    title: 'Database',
    content: 'Supabase/Postgres with migrations, triggers, RLS policies. All data is multi-tenant aware.'
  },
  {
    title: 'Extensibility',
    content: 'Easy to add new features, tables, analytics. Component-based UI. All business logic in migrations/functions.'
  },
  {
    title: 'AI & Automation',
    content: [
  ...
  {
    title: 'Session Summary: Apple-Style Modals, Billing, and Debugging (June 2024)',
    content: [
  ...
  {
    title: 'Comprehensive Session Documentation: Apple-Style Modals, Billing, and UI/UX (June 2024)',
    content: [
      '---',
...
export default function Mtdrb() {
  ...
  const handleAsk = () => {
    ...
    setAnswer('AI Assistant: This is a placeholder answer. In production, I would answer your question about the MTDRB project using my knowledge base.');
  };
    ...
    <div className="min-h-screen bg-blue-50 p-8">
      <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-lg p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-2xl font-bold text-blue-900">MTDRB Project Knowledge Base & AI Assistant</h1>
        </div>
        ...
        <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-semibold text-blue-700">Ask the AI Assistant</span>
          </div>
