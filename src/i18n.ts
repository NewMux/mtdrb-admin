  ...
  en: {
    translation: {
      landing: {
        ...
        subheadline:
          "All-in-one management, automation, and growth for fitness businesses — in English & Arabic.",
        ...
        how_step1_desc:
          "Sign up in seconds and set up your gym or studio profile.",
        how_step2_title: "Add Your Team & Branches",
        how_step2_desc:
          "Invite staff, add locations, and configure your business in one place.",
        how_step3_title: "Start Managing Effortlessly",
        how_step3_desc:
          "Automate operations, track growth, and delight your members.",
      },
    },
  },
  ar: {
    translation: {
      landing: {
        ...
        subheadline:
          "إدارة شاملة، أتمتة، ونمو للأعمال الرياضية — بالإنجليزية والعربية.",
